...
class Configuration(object):
    ...
    def initialize(cls, linux=None, load_interface=True):
        ...
        if cls.remote_server_port is None or cls.linux is None:
    ...
    def load_from_arguments(cls):
        ...
        from .args_win import Arguments
    ...
    def parse_settings_args(cls, args):
        ...
        if cls.linux is None and args.remote_server_port:
    ...
    def parse_wps_args(cls, args):
        ...
        if args.use_bully:
            from .tools.bully_win import Bully
            if not Bully.exists():
        ...
        if args.use_reaver:
            from .tools.reaver_win import Reaver
